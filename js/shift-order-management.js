                                ...
                                if (!tempEmployeesMap.has(employeeNumber)) {
                                    ...
                                    if (!tempEmployee) {
                                        tempEmployee = {
                                            ...
                                            number: identifier.employeeNumber || identifier.employeeId,
                                            name: identifier.employeeNumber ? `员工${identifier.employeeNumber}` : `员工${identifier.employeeId}`, // 默认名称
